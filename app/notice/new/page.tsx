...
import { useCreateNotice } from "@/lib/noticeQueries";
...
export default function NoticeNewPage() {
  ...
  const create = useCreateNotice(token ?? null);
  ...
  if (!isAdmin) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-16">
        ...
        <p className="mt-2 text-sm text-gray-600">관리자만 작성할 수 있습니다.</p>
      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-10 md:py-14">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">제목과 내용을 입력하세요.</p>
          </div>
        ...
        <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-5 md:p-6">
          ...
          <textarea
            className="mt-2 min-h-[220px] w-full resize-y rounded-xl border border-gray-200 px-3 py-3 text-sm outline-none focus:border-gray-400"
            value={content}
